...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { datecreated: @branch.datecreated, description: @branch.description, name: @branch.name, owner: @branch.owner }
    end
  ...
  test "should update branch" do
    put :update, id: @branch, branch: { datecreated: @branch.datecreated, description: @branch.description, name: @branch.name, owner: @branch.owner }
    assert_redirected_to branch_path(assigns(:branch))
  end
